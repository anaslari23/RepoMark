...
export type VerificationState = 'verified-exact' | 'verified-modified' | 'untrusted' | 'invalid' | 'revoked' | 'inconclusive';
export type KeyTrustStatus = 'TRUSTED' | 'UNTRUSTED' | 'REVOKED_PRE_ISSUANCE' | 'REVOKED_POST_ISSUANCE' | 'AUTHORIZATION_WITHDRAWN' | 'UNKNOWN' | 'REVOKED';
