 ...
 */
export function buildPayloadFrame(payload, macKey) {
 ...
 */
export function verifyPayloadFrame(frame, macKey) {
    if (frame.length !== 32)
        return null;
...
export class PayloadCoder {
    ...
    encode(frame) {
        if (frame.length !== 32)
            throw new Error('Frame must be 32 bytes');
    ...
    decode(shards) {
        if (shards.length !== 63)
            throw new Error('Expected 63 shards');
