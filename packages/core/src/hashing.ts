 ...
 */
export function hashBytes(bytes: Uint8Array | Buffer | string, algorithm: HashAlgorithm = 'sha256'): string {
 ...
 */
export function deriveCopyId(issuanceKey: string | Buffer, recipientInternalId: string, epochOrNonce?: string): string {
 ...
 */
export function validateCanonicalPaths(paths: string[]): string[] {
 ...
 */
export function computeDiagnosticTextDigest(text: string): string {
