 ...
 */
export function createDeterministicZip(entries: ZipEntryInput[]): Buffer {
  ...
  for (const entry of sorted) {
    ...
    let finalData: Buffer = compressedData;
 ...
 */
export function extractZipToDirectory(zipBuffer: Buffer, targetDir: string): void {
